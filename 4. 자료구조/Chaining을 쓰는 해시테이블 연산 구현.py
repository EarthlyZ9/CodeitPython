...
class HashTable:
    ...
    def _get_linked_list_for_key(self, key):
        ...
        return self._table[
            hashed_index
        ]  # self._table 리스트에서 hased_index에 해당하는 링크드 리스트 리턴

    def _look_up_node(self, key):
        """_get_linked_list_for_key를 이용해 가져온 링크드 리스트 안에서 파라미터로 받은 key를 갖고 있는 노드를 리턴"""
    ...
    def insert(self, key, value):
        ...
        """
        exisiting_node = self._look_up_node(key)  # 이미 저장된 key인지 확인
